...
const WhatsAppFloat = () => {
  ...
  const topics = [
    { id: 'general', label: 'General Inquiry', message: 'Hello! I would like to know more about your products.' },
    { id: 'order', label: 'Order Support', message: 'Hi! I need help with my order.' },
    { id: 'wholesale', label: 'Wholesale/Business', message: 'Hello! I am interested in wholesale opportunities.' },
  ];
            ...
            <div className="p-3 space-y-1.5">
              ...
              <div className="pt-1">
                <a
                  ...
                  className="w-full flex items-center justify-center gap-2 p-3 bg-slate-900 text-white rounded-xl font-black text-[9px] uppercase tracking-widest hover:bg-maroon transition-all shadow-lg active:scale-95"
                >
