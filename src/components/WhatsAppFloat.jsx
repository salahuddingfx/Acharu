            ...
            <div className="p-5 space-y-4">
              <div className="bg-slate-50 p-4 rounded-2xl border border-slate-100">
                <p className="text-[10px] text-slate-600 font-medium leading-relaxed mb-3">
                  Thank you for visiting us! We are always here to help you with your cravings. 🌶️
                </p>
              ...
              <div className="space-y-2">
                ...
                <a
                  ...
                  className="w-full flex items-center justify-center gap-2 p-3 bg-slate-900 text-white rounded-xl font-black text-[10px] uppercase tracking-widest hover:bg-maroon transition-all shadow-lg active:scale-95"
                >
