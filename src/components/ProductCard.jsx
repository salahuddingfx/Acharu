...
const ProductCard = ({ product }) => {
  ...
  return (
    <motion.div 
      ...
      viewport={{ once: true }}
      className="group relative bg-white rounded-[1.5rem] shadow-sm hover:shadow-2xl hover:shadow-maroon/10 border border-slate-100 overflow-hidden transition-all duration-500 h-full flex flex-col"
    >
      {/* Image Container */}
      <div className="relative aspect-square overflow-hidden bg-slate-50">
        ...
        {product.original_price && product.original_price > product.price && (
          <div className="absolute top-3 left-3 bg-maroon text-white text-[8px] font-black px-2 py-1 rounded-full shadow-lg z-10">
        ...
        <div className="absolute inset-0 bg-slate-900/40 opacity-0 group-hover:opacity-100 transition-all duration-500 flex items-center justify-center gap-1.5 backdrop-blur-[1px]">
           <button 
             ...
             className="w-9 h-9 rounded-full bg-white text-slate-900 flex items-center justify-center hover:bg-maroon hover:text-white transition-all transform translate-y-4 group-hover:translate-y-0 duration-500 shadow-xl"
           >
      ...
      <div className="p-3 flex flex-col flex-grow">
        <div className="flex-grow">
          <Link 
            ...
            className={clsx(
              "text-sm font-bold text-slate-800 hover:text-maroon transition-colors line-clamp-2 leading-tight mb-1",
        ...
        <div className="mt-2 pt-2 border-t border-slate-50 flex items-center justify-between">
          ...
          <button 
            ...
            className="w-9 h-9 rounded-lg bg-maroon text-white flex items-center justify-center shadow-lg shadow-maroon/10 hover:shadow-maroon/20 hover:-translate-y-0.5 transition-all group/btn"
          >
