      ...
      <div className="p-4 flex flex-col flex-grow">
        <div className="flex-grow">
          <Link 
            to={`/product/${product.slug || product.id}`}
            className={clsx(
              "text-sm font-bold text-slate-800 hover:text-maroon transition-colors line-clamp-1 leading-tight mb-1",
        ...
        <div className="mt-2 pt-3 border-t border-slate-50 flex items-center justify-between gap-2">
          ...
          <div className="flex items-center gap-1.5 shrink-0">
            <button 
              ...
              className="w-9 h-9 rounded-lg bg-slate-100 text-slate-600 flex items-center justify-center hover:bg-maroon hover:text-white transition-all shadow-sm"
              title="Add to Cart"
            >
