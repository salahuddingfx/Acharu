      ...
      {show && (
        ...
        >
          ...
          <div className="flex flex-col items-center text-center">
            <div className="w-16 h-16 bg-maroon/5 rounded-full flex items-center justify-center mb-4 relative">
              <Bell className="text-maroon animate-bounce" size={32} />
            ...
            <h3 className="text-xl font-display font-black text-slate-800 mb-2">Get Real-time Updates</h3>
            <p className="text-slate-500 text-sm mb-6 px-2">Enable notifications for real-time order tracking and exclusive spice deals.</p>
            ...
            <div className="flex gap-3 w-full">
               ...
               <button 
                 ...
                 disabled={loading}
                 className="flex-1 py-3 px-4 rounded-2xl bg-maroon text-white font-bold shadow-lg shadow-maroon/20 hover:shadow-xl hover:-translate-y-0.5 transition-all disabled:opacity-70"
               >
