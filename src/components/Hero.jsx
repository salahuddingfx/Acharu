        ...
        >
          ...
          <img 
            ...
            onError={(e) => {
              ...
              e.target.src = 'https://images.unsplash.com/photo-1589135233689-d58620025983?q=80&w=1200';
            }}
        ...
        <div className="w-full pb-6 md:pb-10 flex flex-col md:flex-row items-center justify-between gap-4 md:gap-6">
          ...
          <div className="flex items-center gap-4 md:gap-10">
            ...
            <div className="flex items-center gap-3">
              <button 
                onClick={prevSlide} 
                className="w-12 h-12 rounded-xl border border-white/10 flex items-center justify-center text-white hover:bg-white hover:text-slate-950 transition-all duration-500"
