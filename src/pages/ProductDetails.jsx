            ...
            <div className="lg:col-span-7 flex flex-col gap-6">
              ...
              <div className="bg-maroon/5 border border-maroon/10 p-6 md:p-8 rounded-3xl flex items-center justify-between hover:bg-maroon/10 transition-all group overflow-hidden relative">
                <div className="relative z-10">
                  <h5 className="text-[10px] font-black text-maroon uppercase tracking-[0.2em] mb-2 opacity-70">Quality Assurance</h5>
                  <p className="text-xl md:text-2xl font-black text-slate-800 tracking-tight group-hover:text-maroon transition-colors">
                    100% Authentic & Homemade
                  </p>
                  <p className="text-xs text-slate-500 font-medium mt-1">Sourced from the finest traditional recipes</p>
                </div>
