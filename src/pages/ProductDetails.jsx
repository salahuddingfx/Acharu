        ...
        <div className="max-w-lg mx-auto px-4 py-3">
          ...
          <div className="flex items-center justify-between mb-2">
            <div>
              ...
              <p className="text-lg font-black text-emerald-600 leading-none">৳{((selectedVariation ? selectedVariation.price : product.price) * quantity).toFixed(0)}</p>
            </div>
            {/* Qty Controls */}
            <div className="flex items-center bg-slate-100 rounded-xl p-0.5 border border-slate-200">
              <button 
                onClick={() => updateProductQuantity(quantity - 1)}
                className="w-9 h-9 flex items-center justify-center text-slate-600 hover:text-maroon transition-colors"
