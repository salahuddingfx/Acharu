...
const OrderSuccess = () => {
  ...
  return (
    <>
      <Helmet>
        <title>Order Success | Acharu</title>
      </Helmet>
      <div className="bg-cream min-h-screen py-20 flex items-center">
        <div className="container-custom max-w-2xl mx-auto">
          ...
          >
            ...
            <h1 className="text-4xl font-display font-black text-slate-800 mb-4">Order Confirmed!</h1>
            <p className="text-slate-500 mb-10 text-lg">Thank you for shopping with Acharu. Your authentic homemade treats are on their way!</p>

            <div className="bg-slate-50 rounded-3xl p-8 mb-10 border border-slate-100">
              <div className="text-[10px] font-black uppercase tracking-widest text-slate-400 mb-2">Your Tracking ID</div>
            ...
            <p className="text-slate-400 text-sm">
              A confirmation message will be sent to your phone number shortly.
            </p>
          </motion.div>
        </div>
      </div>
