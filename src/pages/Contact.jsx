...
const Contact = () => {
  ...
  const contactInfo = [
    ...
    },
    {
      icon: <Mail size={24} />,
      title: "Email Us",
      details: contact.store_email || contact.email || "hello@acharu.com",
      description: "Our friendly team is here to help",
      color: "bg-maroon",
      lightColor: "bg-maroon/5 text-maroon"
    },
    {
      icon: <MapPin size={24} />,
      title: "Visit Us",
      details: contact.address || "House 123, Road 4, Cox's Bazar, Bangladesh",
      description: "Headquarters",
      color: "bg-teal-500",
      lightColor: "bg-teal-50/50 text-teal-600"
    }
  ];
  ...
  return (
    <div className="bg-[#FAF9F6] min-h-screen">
      ...
      <section className="relative h-[60vh] min-h-[500px] bg-maroon overflow-hidden flex items-center">
        {/* Background Elements */}
          ...
          <div className="max-w-4xl">
            ...
            >
              ...
              <h1 className="text-6xl md:text-8xl font-display font-black text-white leading-[1.1] tracking-tighter mb-8">
                Let's start a <br />
                <span className="text-cream/40">conversation.</span>
              </h1>
              <p className="text-cream/70 text-lg md:text-xl max-w-xl leading-relaxed font-medium">
                Whether you have a question about our artisanal pickles, a bulk order inquiry, 
        ...
        <div className="absolute bottom-10 left-1/2 -translate-x-1/2 flex flex-col items-center gap-3 opacity-30">
          <span className="text-[9px] font-black uppercase tracking-[0.3em] text-cream">Scroll</span>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
          ...
          <div className="lg:col-span-4 space-y-6">
            ...
            <motion.div 
              ...
              className="bg-slate-900 p-10 rounded-[40px] text-white shadow-2xl relative overflow-hidden group"
            >
              ...
              <div className="relative z-10">
                <div className="flex items-center gap-4 mb-8">
                  <div className="w-10 h-10 rounded-xl bg-white/10 flex items-center justify-center">
                    <Clock size={20} className="text-maroon-light" />
                  </div>
                  <h4 className="text-xs font-black uppercase tracking-[0.2em] text-slate-400">Operating Hours</h4>
                </div>
                
                <div className="space-y-5">
                  <div className="flex justify-between items-center group/item">
                    <span className="text-slate-400 text-sm font-bold group-hover/item:text-white transition-colors">Sat - Thu</span>
                    <span className="text-sm font-black tracking-tight bg-white/5 px-4 py-2 rounded-xl">9:00 AM - 8:00 PM</span>
                  </div>
                  <div className="flex justify-between items-center group/item">
                    <span className="text-slate-400 text-sm font-bold group-hover/item:text-white transition-colors">Friday</span>
                    <span className="text-sm font-black tracking-tight text-maroon-light bg-maroon-light/5 px-4 py-2 rounded-xl border border-maroon-light/20 uppercase">Closed</span>
                  </div>
                </div>

                <div className="mt-10 pt-8 border-t border-white/5 flex gap-4">
                  {[Facebook, Instagram, Twitter, MessageCircle].map((Icon, i) => (
                    <button key={i} className="w-10 h-10 rounded-xl bg-white/5 border border-white/5 flex items-center justify-center hover:bg-white hover:text-slate-900 transition-all duration-500">
                      <Icon size={18} />
                    </button>
                  ))}
                </div>
          ...
          >
            <div className="p-8 md:p-12 lg:p-20 relative">
              ...
              <div className="relative z-10">
                <header className="mb-12">
                  <div className="inline-flex items-center gap-3 px-4 py-2 rounded-2xl bg-slate-50 border border-slate-100 text-slate-400 mb-6">
                ...
                <form onSubmit={handleSubmit} className="space-y-8">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                    <div className="group space-y-3">
                      <label className="text-[10px] font-black uppercase tracking-[0.2em] text-slate-400 ml-1 group-focus-within:text-maroon transition-colors">
                        Full Name
                      </label>
                      <input 
                        type="text" 
                        ...
                        className="w-full px-8 py-5 bg-slate-50 border border-slate-100 rounded-[24px] focus:outline-none focus:ring-4 focus:ring-maroon/5 focus:bg-white focus:border-maroon/20 transition-all font-bold text-slate-800 placeholder:text-slate-300"
                      />
                    </div>
                    <div className="group space-y-3">
                      <label className="text-[10px] font-black uppercase tracking-[0.2em] text-slate-400 ml-1 group-focus-within:text-maroon transition-colors">
                  ...
                  <div className="group space-y-3">
                    ...
                    <div className="relative">
                      <select 
                        ...
                        onChange={handleChange}
                        className="w-full px-8 py-5 bg-slate-50 border border-slate-100 rounded-[24px] focus:outline-none focus:ring-4 focus:ring-maroon/5 focus:bg-white focus:border-maroon/20 transition-all font-bold text-slate-800 appearance-none cursor-pointer"
                      >
                  ...
                  <div className="group space-y-3">
                    ...
                    <textarea 
                      ...
                      rows="6" 
                      className="w-full px-8 py-6 bg-slate-50 border border-slate-100 rounded-[32px] focus:outline-none focus:ring-4 focus:ring-maroon/5 focus:bg-white focus:border-maroon/20 transition-all font-bold text-slate-800 placeholder:text-slate-300 resize-none"
                    ></textarea>
                  </div>
                  ...
                  <div className="pt-6 flex flex-col md:flex-row items-center justify-between gap-8">
                    ...
                    <button 
                      type="submit" 
                      disabled={loading}
                      className="w-full md:w-auto bg-maroon text-white px-12 py-6 rounded-[24px] font-black uppercase tracking-[0.2em] text-[10px] shadow-maroon/20 shadow-2xl hover:bg-maroon-dark hover:scale-[1.02] active:scale-95 transition-all duration-500 flex items-center justify-center gap-4 group disabled:opacity-70 disabled:cursor-not-allowed"
                    >
                      {loading ? (
                        <>
            ...
            <div className="h-4 bg-gradient-to-r from-maroon via-maroon-light to-maroon shadow-inner" />
          </motion.div>
        </div>
      </div>
    </div>
