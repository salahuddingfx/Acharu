          ...
          <div className="container-custom">
            <div className="flex justify-between items-end mb-12 px-4 md:px-0">
              ...
              <div className="flex gap-2 md:gap-4 shrink-0">
                 <button 
                  onClick={() => scroll('left')}
                  className="w-10 h-10 md:w-12 md:h-12 rounded-full border border-slate-100 flex items-center justify-center text-slate-600 hover:bg-maroon hover:text-white transition-all"
                ...
                >
                 ...
                 <button 
                  ...
                  className="w-10 h-10 md:w-12 md:h-12 rounded-full border border-maroon flex items-center justify-center text-maroon hover:bg-maroon hover:text-white transition-all"
