...
const Wishlist = () => {
  ...
  return (
    <>
      <Helmet>
        <title>My Wishlist | Acharu</title>
      </Helmet>
      <div className="bg-cream min-h-screen py-20">
        <div className="container-custom">
          <div className="flex flex-col md:flex-row justify-between items-center mb-12 gap-6">
            <div>
              <h1 className="text-4xl md:text-5xl font-display font-black text-slate-800 mb-2">My Favorites</h1>
          ...
          {wishlistItems.length > 0 ? (
            ...
            >
              ...
              <h3 className="text-2xl font-display font-black text-slate-800 mb-4">Your Wishlist is Empty</h3>
              <p className="text-slate-400 mb-10 max-w-md mx-auto">Looks like you haven't saved any pickles yet. Start exploring our authentic collection!</p>
