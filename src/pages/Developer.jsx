      ...
      <div className="container-custom relative z-10">
        <div className="max-w-5xl mx-auto">
          ...
          <div className="text-center mb-20">
            ...
            >
              This platform was engineered to deliver a seamless multi-store e-commerce experience, blending heritage aesthetics with modern performance.
            </motion.p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-10">
            ...
            <motion.div 
              ...
              className="md:col-span-1 bg-white p-10 rounded-[40px] shadow-premium border border-slate-100 flex flex-col items-center text-center"
            >
